...
export default function NewsWidget({ articles }: { articles: NewsArticle[] }) {
  // Línea de seguridad: si no hay noticias todavía, no renderiza nada y evita errores
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {articles.map((article) => (
          <a
            ...
            className="group block bg-slate-950 border border-slate-800 p-5 rounded-xl hover:border-blue-500/50 hover:bg-slate-800 transition-all duration-300 cursor-pointer"
          >
